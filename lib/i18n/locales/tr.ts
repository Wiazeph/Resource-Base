export const tr = {
  ...
  auth: {
    ...
    welcomeNew: "Hoş geldin! Hesabın hazır.",
    ...
    confirmPasswordPlaceholder: "Yeni şifreyi tekrarla",
    ...
    connectedAccountsHint:
      "Sağlayıcıları bağlayarak herhangi biriyle giriş yapabilirsin. E-posta/şifre de bir yöntem sayılır.",
    link: "Bağla",
    unlink: "Bağlantıyı kes",
    linked: "Bağlı",
    cannotUnlinkLast: "Tek giriş yöntemini bağlantıdan çıkaramazsın.",
    linkFailed: "Bu sağlayıcı bağlanamadı.",
    unlinkFailed: "Bu sağlayıcının bağlantısı kesilemedi.",
  },
